...
LAMBDA_ROOF="${LAMBDA_ROOF:-0.15}"
LAMBDA_ROOF_CORNER="${LAMBDA_ROOF_CORNER:-0.1}"
FREEZE_BACKBONE_EPOCHS="${FREEZE_BACKBONE_EPOCHS:-5}"
...
echo "Epochs: ${EPOCHS}"
echo "LR main/backbone/roof: ${LR} / ${LR_BACKBONE} / ${LR_ROOF}"
echo "LR scheduler: ${LR_SCHEDULER}, warmup=${WARMUP_EPOCHS}, min_ratio=${MIN_LR_RATIO}"
echo "Lambda roof: ${LAMBDA_ROOF}"
echo "Lambda roof corner: ${LAMBDA_ROOF_CORNER}"
...
train_args=(
  ...
  --lambda_roof_corner "${LAMBDA_ROOF_CORNER}"
